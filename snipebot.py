...
# 2: POST SERVER RANK OF USER WHEN THEY DO -SNIPES
# 3: BETTER -HELP COMMAND FORMAT
# 4: -ping COMMAND TO ENABLE PINGS FOR USERS WHEN THEY ARE SNIPED
# 5: -link COMMAND TO LINK USERS DISCORD ID TO THEIR OSU ID
